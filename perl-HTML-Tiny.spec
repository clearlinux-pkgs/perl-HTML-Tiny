...
%package man
Summary: man components for the perl-HTML-Tiny package.
Group: Default

%description man
man components for the perl-HTML-Tiny package.
...
mkdir -p %{_topdir}/BUILD/HTML-Tiny-1.05/deblicense/
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/HTML/Tiny.pm
