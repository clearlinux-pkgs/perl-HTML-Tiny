...
Source0  : https://cpan.metacpan.org/authors/id/A/AR/ARISTOTLE/HTML-Tiny-1.07.tar.gz
...
%prep
%setup -q -n HTML-Tiny-1.07
cd %{_builddir}
tar xf %{_sourcedir}/libhtml-tiny-perl_1.05-3.debian.tar.xz
cd %{_builddir}/HTML-Tiny-1.07
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/HTML-Tiny-1.07/deblicense/
